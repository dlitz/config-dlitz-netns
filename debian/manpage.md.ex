% config-dlitz-netns(SECTION) | User Commands
%
% "November 18 2023"
...
config-dlitz-netns - program to do something

# SYNOPSIS

**config-dlitz-netns** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**config-dlitz-netns** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **config-dlitz-netns** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**config-dlitz-netns** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    config-dlitz-netns. See **foo.conf**(5) for further details.
...
**config-dlitz-netns** provides some return codes, that can be used in scripts:
...
Copyright © 2007 Darsey Litzenberger
